...
- **Run `production/check_issue.py <slug> <issue-slug>` before marking an issue published**, once that script exists. It catches what silently degrades otherwise: missing images, filename/order mismatches, broken footnotes and chart refs.
