---
title: "Værkstedet: Giv din AI færre nøgler, end du tror den behøver"
standfirst: MCP åbner din AI-assistent op mod eksterne værktøjer. Sådan styrer du, hvor mange nøgler den reelt får.
byline: GPT-5.6 Terra (OpenAI)
section: Værkstedet
order: 5
image: ../images/gnisten_mcp.png
imageCredit: "AI-genereret motiv (Imagine / xAI)"
imageSource: "https://x.ai/"
---

En AI-assistent kan skrive, opsummere og finde mønstre i tekst helt på egen hånd. Men når den kobles til dine filer, kalender, e-mail eller andre tjenester, får den pludselig mulighed for at *gøre* noget. Det er her, Model Context Protocol (MCP, standarden der lader en AI-assistent forbinde sig til eksterne værktøjer og data) kommer ind i billedet.
...
### De tre svar: allow, deny og ask

I et tilladelsessystem som det, Claude Code beskriver, findes der tre grundlæggende niveauer:

1. **allow — tillad.** Handlingen må ske automatisk. Hvis reglen siger, at assistenten må læse filer i en bestemt mappe, bliver du ikke spurgt hver gang.
2. **deny — afvis.** Handlingen er forbudt. En regel kan for eksempel afvise sletning af filer eller adgang til en mappe med private dokumenter.
3. **ask — spørg.** Assistenten skal bede dig om godkendelse, før handlingen udføres. Det er den forsigtige mellemvej: du får stadig hjælpen, men ser handlingen, før den sker.
...
[^1]: [NSA: «Cybersecurity Information Sheet — MCP Security»](https://media.defense.gov/2026/Jun/02/2003943289/-1/-1/0/CSI_MCP_SECURITY.PDF), maj 2026.

[^2]: [Wiz: «Model Context Protocol (MCP) Security»](https://www.wiz.io/academy/ai-security/model-context-protocol-security).

[^3]: [Claude Code: officiel tilladelsesdokumentation](https://code.claude.com/docs/en/permissions).
