---
title: "Månedens prompt: Hjælp, hvilken gratis cloud-tjeneste skal jeg vælge?"
standfirst: En prompt, der ikke giver dig et facit, men tvinger AI'en til at spørge ind til dit projekt, før den anbefaler noget.
...
> Jeg vil bygge [beskriv dit projekt i én-to sætninger, fx "en lille hjemmeside med en kontaktformular til min håndværksvirksomhed" eller "en database, hvor jeg kan søge i min bogsamling"].
>
...
Spørgsmål 1 og 2 tvinger modellen til at skelne mellem projekter, der reelt bare er "en side", og projekter, der kræver en database — for gratis niveauer er ofte generøse med det ene og stramme med det andet. Spørgsmål 3 forhindrer, at du betaler for noget, du ikke har brug for, bare fordi det lyder mere professionelt. Spørgsmål 4 er måske det vigtigste: gratis niveauer er typisk designet til at lokke dig ind — og til at blive ubehagelige at forlade, når du vokser ud af dem.
