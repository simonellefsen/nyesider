...
### Seks snapshots (forenklet)

| Land | El-mix (ca.) | At følge |
| --- | --- | --- |
...
| **USA** | Gas-tung flex + voksende sol/vind; atom stabilt, men gammelt | Net, data center-load, SMR-piloter |
| **Kina** | Verdens største VE-udbygning + atomvækst | IEA: stor del af ny global atom 2026–30[^2] |
