...
- **Artikeltal:** 14 (nr. 1). Faste: Leder · features (protein/ernæring/tilskud/hardware) · Longevity & aldring · Tallet · Ordbogen · Rygtebørsen · Til PULSEN.
- **Ordmål:** ingen fast norm sat før nr. 1 (endte 87–431 ord/artikel, se `bestilling.json`-retrofit for nr. 1); sigt fremover på 200–350 for features, 350–500 for Tallet.
- **Standard `mustCite`:** 1–2 for enhver artikel med et sundheds-/ernæringstal (dosis, µg, g/kg, andel der tager tilskud); 6+ for Tallet (kildetabel, ikke ballpark — se `11-tallet.md` som skabelon, nu også husregel i [redaktion/README](../README.md)); 0 for Ordbogen/Rygtebørsen.
...
- **(2026-08) GLP-1 og ernæring under behandling** (forsigtig, kilde-tung)  
- **(2026-08) Søvn som "tilskud" der virker**  
