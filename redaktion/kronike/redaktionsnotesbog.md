...
- **Artikeltal:** typisk 10–14.  
- **Ordmål:** features **450–800** (sigt dybde som KRAFTEN’s Sverige-atom). Tallet 250–450. Leder 120–220. Bagsnit korte.  
- **Ingen Ordbog, ingen Rygtebørs.** Gloser i parentes/fodnote. Eventuelt bagsnit: *Myter & missforståelser*.  
- **Standard `mustCite`:** 2+ for tal/årstal-tunge features; 0 for leder/myter (når bevidst).  
